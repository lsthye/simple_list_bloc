...
void main() {
  ...
  setUp(() => bloc = SortIntListBloc(ListState(initialized: false, filter: false)));
  group('list bloc', () {
    ...
    blocTest<SortIntListBloc, ListState>(
      ...
      build: () => SortIntListBloc(ListState(filter: false)),
    ...
    blocTest<SortIntListBloc, ListState>(
      'should append list',
      build: () => SortIntListBloc(ListState(items: [5, 6, 7], filter: false)),
      act: (bloc) => bloc.add(FetchItems(filter: false)),
      verify: (bloc) async {
        expect(bloc.state.initialized, equals(true));
    ...
    var state12345 = ListState<int, bool>(items: [1, 2, 3, 4, 5], filter: false);
    blocTest<SortIntListBloc, ListState>(
      'should change state to loading before refresh',
      build: () => SortIntListBloc(ListState(items: [1, 2, 3, 4, 5], filter: false)),
    ...
    blocTest<SortIntListBloc, ListState>(
      ...
      build: () => SortIntListBloc(ListState(filter: false)),
      act: (bloc) => bloc.add(PublishState<int, bool>(ListState(items: [1, 3, 2, 5], filter: false))),
      verify: (bloc) {
    ...
    blocTest<IntListBloc, ListState>(
      ...
      build: () => IntListBloc(ListState(filter: false)),
      act: (bloc) {
        bloc.add(PublishState<int, bool>(ListState(items: [1, 3, 2, 5], filter: false)));
      },
      verify: (bloc) async {
    ...
    blocTest<ListBloc, ListState>(
      ...
      build: () => ListBloc(state: ListState(items: [1, 2, 3], filter: false), debounce: 0),
    ...
    blocTest<ListBloc, ListState>(
      ...
      build: () => ListBloc(state: ListState(items: [1, 2, 3], filter: false), debounce: 0, allowDuplicate: true),
    ...
    blocTest<ListBloc, ListState>(
      'should remove items',
      build: () => ListBloc(state: ListState(items: [1, 2, 3, 4, 5], filter: false), debounce: 0, allowDuplicate: true),
    ...
    blocTest<ListBloc, ListState>(
      ...
      build: () => ListBloc(debounce: 0, state: ListState(filter: false, items: [])),
    ...
    blocTest<ListBloc, ListState>(
      ...
      build: () => ListBloc(debounce: 80, state: ListState(filter: false)),
      act: (bloc) {
        bloc.add(AddItems([0]));
        bloc.add(AddItems([1]));
        bloc.add(AddItems([2]));
